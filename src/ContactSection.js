    ...
    <div className="contactpage">
      <div className="container">
        <form name="contact" method="post">
          ...
          <p>
            <input type="text" className="changeWidth" placeholder="Enter name" name="name" />
          </p>
          <p>
            <input ref={emailRef} onChange={ValidateInput} type="email" className="changeWidth" placeholder="Enter email*" name="email" />
          </p>
          <p>
            <textarea ref={messageRef} onChange={ValidateInput} className="changeWidth" name="message" placeholder="Enter your message here*"></textarea>
          </p>
          <p>
