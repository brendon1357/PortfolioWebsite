        ...
        <div className="imagedisplay">
            <div className="centerdiv">
                ...
                <p className="lead" style={{ fontFamily: "Arial", fontSize: "1rem", color: "white", marginTop: "25px", marginBottom: "35px" }}>
                    My name is Brendon and I am a 23-year-old <span style={{ fontWeight: "bold" }}>Memorial University of Newfoundland</span> senior Computer
                    Science student. I have a passion for software development and love creating and building practical things. I have built projects in the
                    areas of
