			...
			<div className="aboutSection">
				...
				<div className="aboutInfo">
					<p style={{ fontFamily: "Arial", fontSize: "1rem", color: "white", marginTop: "15px", marginBottom: "20px" }}>
						Hello! My name is Brendon, and I'm a 24-year-old software developer with a passion for programming and building software. I recently joined Nasdaq Verafin as a senior software developer working apart of their application platform team. I previously worked as a software developer for PragmaClin Research Inc. A startup company that is building digital solutions for assessing and managing Parkinson's disease.
					</p>
					<p style={{ fontFamily: "Arial", fontSize: "1rem", color: "white", marginTop: "25px", marginBottom: "20px" }}>In my free time I love to learn about new technologies and I do so by building projects. Some of these projects include a password manager, a real-time online desktop chatroom, and a 2D platformer/shooter. I am currently working on a budget management web app that utilizes React in the front end and Java Spring boot in the backend.</p>
